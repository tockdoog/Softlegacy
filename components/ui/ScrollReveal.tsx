...
// arriba) cuando entra en el viewport, con una curva de easing suave estilo
// Apple. Se usa en todas las secciones para dar sensación de interfaz
// dinámica sin duplicar lógica de animación.
